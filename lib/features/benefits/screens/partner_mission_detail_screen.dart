          ...
          if (m.isBlog)
            Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text('제품·메뉴 제공과 포인트 보상을 구분해 확인하세요. 게시물에는 제공받은 혜택을 표시해야 해요.',
                ...
                if (m.providerId.isNotEmpty)
                  Padding(
                    ...
                    child: Text('공급 · ${providerOf(m.providerId).name} · ${providerOf(m.providerId).statusLabel}',
                        style: AppType.caption.copyWith(fontSize: 11.5, height: 1.6, color: AppColors.yellowDeep)),
                  ),
              ]),
            ),
