      ...
      child: InkWell(
        onTap: () => Navigator.push(
          ...
          MaterialPageRoute(builder: (_) => ScreenFrame(
            ...
            child: BenefitsView(
              points: widget.points, steps: widget.steps, coupons: widget.coupons, items: widget.items,
              scope: widget.scope, actions: widget.actions, monthEarn: widget.monthEarn,
              monthPoints: widget.monthPoints, freeLeft: widget.freeLeft, doneMissions: widget.doneMissions,
