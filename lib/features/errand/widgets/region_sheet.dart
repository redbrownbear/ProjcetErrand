...
/// showModalBottomSheet의 builder로 쓰는 지역 선택 시트.
/// 항목을 고르면 Navigator.pop(context, 고른값)으로 돌려줌 — showModalBottomSheet 자체가
/// 배경 스크림/닫기 동작을 처리해주므로 이 위젯은 시트 내용만 그림.
class RegionSheet extends StatelessWidget {
  final String scope;
  const RegionSheet({super.key, required this.scope});
